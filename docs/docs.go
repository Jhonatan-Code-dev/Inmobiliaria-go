...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/user/alquileres": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Buscar por cliente o código de unidad",
                        "name": "buscar",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.listadoAlquileresResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controller.alquilerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/citas/config-formulario": {
            "get": {
                "tags": [
                    "Citas"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.listadoClientesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.clienteRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controller.clienteResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/clientes/tipos-identificacion": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controller.tipoIdentificacionResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ResumenGeneral"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/dashboard/contratos-por-vencer": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.ContratoProximoVencer"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/user/dashboard/estado-cuenta/{clienteId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID del cliente (inquilino)",
                        "name": "clienteId",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.EstadoCuentaCliente"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ReporteFinanciero"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ResumenMorosidad"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ResumenOcupacion"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/dashboard/top-unidades": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.TopUnidad"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.listadoGastosResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.gastoRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controller.tipoPagoResponse"
                            }
                        }
                    }
                }
        ...
        "/api/user/inmuebles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Búsqueda por nombre, dirección o ciudad",
                        "name": "buscar",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filtrar por tipo de inmueble",
                        "name": "tipo",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.listadoInmueblesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.inmuebleRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controller.inmuebleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/inmuebles/{id}/unidades": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controller.unidadResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.unidadRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/user/inmuebles/{id}/unidades/{unidadId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.registrarPagoRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/controller.pagoAlquilerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controller.pendientePagoResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/user/reportes/categorias-gastos": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.DistribucionCategoriaGasto"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/user/reportes/ingresos-gastos": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ReporteIngresosGastos"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/user/reportes/metodos-pago": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.DistribucionMetodoPago"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/user/reportes/rentabilidad-propiedades": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.RentabilidadPropiedad"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/user/reportes/tickets-mantenimiento": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ResumenMantenimientoReporte"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "controller.alquilerRequest": {
            ...
            "properties": {
                ...
                "vencimiento_dia_pago": {
                    "type": "integer"
                }
            }
        },
        "controller.alquilerResponse": {
            "type": "object",
            "properties": {
                "cliente": {
                    "type": "string"
        ...
        "controller.listadoAlquileresResponse": {
            "type": "object",
            "properties": {
                "datos": {
                    "type": "array",
        ...
        "controller.listadoClientesResponse": {
            "type": "object",
            "properties": {
                "datos": {
                    "type": "array",
        ...
        "controller.listadoGastosResponse": {
            "type": "object",
            "properties": {
                "datos": {
                    "type": "array",
        ...
        "controller.listadoInmueblesResponse": {
            "type": "object",
            "properties": {
                "datos": {
                    "type": "array",
        ...
        "controller.pendientePagoResponse": {
            "type": "object",
            "properties": {
                "alquiler_id": {
                    "type": "integer"
        ...
        "controller.registrarPagoRequest": {
            "type": "object",
            "properties": {
                "alquiler_id": {
                    "type": "integer"
        ...
        "controller.tipoIdentificacionResponse": {
            "type": "object",
            "properties": {
                "activo": {
                    "type": "boolean"
        ...
        "domain.DistribucionCategoriaGasto": {
            "type": "object",
            "properties": {
                "cantidad_gastos": {
                    "type": "integer"
                ...
                "categoria": {
                    "description": "Nombre del TipoPago",
                    "type": "string"
                },
                "porcentaje": {
                    "type": "number"
        ...
        "domain.DistribucionMetodoPago": {
            ...
            "properties": {
                ...
                "metodo": {
                    "description": "\"efectivo\", \"transferencia\", \"yape\", etc.",
                    "type": "string"
                },
                "porcentaje": {
                    "type": "number"
        ...
        "domain.EstadoCuentaCliente": {
            ...
            "properties": {
                "cargos": {
                    "description": "Desglose de cargos",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.CargoResumen"
                    }
                },
                "cliente_id": {
                    "type": "integer"
        ...
        "domain.ReporteFinanciero": {
            ...
            "properties": {
                ...
                "serie_mensual": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.PuntoFinanciero"
                    }
                },
                "total_gastos": {
                    "type": "number"
        ...
        "domain.ReporteIngresosGastos": {
            ...
            "properties": {
                ...
                "serie_mensual": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.PuntoIngresoGasto"
                    }
                },
                "total_gastos": {
                    "type": "number"
        ...
        "domain.ResumenGeneral": {
            ...
            "properties": {
                ...
                "ingresos_mes_actual": {
                    "description": "Finanzas del mes actual",
                    "type": "number"
                },
                "mes": {
                    "description": "Periodo",
        ...
        "domain.ResumenMantenimientoReporte": {
            "type": "object",
            "properties": {
                "por_estado": {
                    "$ref": "#/definitions/domain.TicketsPorEstado"
                },
                "por_prioridad": {
                    "$ref": "#/definitions/domain.TicketsPorPrioridad"
                },
                "total_tickets": {
                    "type": "integer"
                }
        ...
        "domain.ResumenMorosidad": {
            ...
            "properties": {
                ...
                "morosos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ClienteMoroso"
                    }
                },
                "total_morosos": {
                    "type": "integer"
        ...
        "domain.ResumenOcupacion": {
            "type": "object",
            "properties": {
                "por_propiedad": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.OcupacionPropiedad"
                    }
                },
                "tasa_global_pct": {
                    "type": "number"
